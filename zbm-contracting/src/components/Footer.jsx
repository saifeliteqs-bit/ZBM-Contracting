    ...
    <footer className="footer" ref={footerRef}>
      <div className="footer__top container">
        ...
        <div className="footer__col">
          ...
          <a href="mailto:info@zbmcontracting.com" className="footer__link footer__link--accent">
            info@zbmcontracting.com
          </a>
          <p className="footer__link footer__link--accent">Dubai, UAE</p>
        </div>
      ...
      <div className="footer__bottom container">
        <p className="footer__copy">© {new Date().getFullYear()} ZBM Contracting LLC. All rights reserved.</p>
        <p className="footer__copy">We build the future.</p>
      </div>
    </footer>
  );
}
