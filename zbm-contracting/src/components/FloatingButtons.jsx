  ...
  return (
    <div className={`fab ${isOpen ? 'fab--open' : ''}`} ref={wrapRef}>
      ...
      <div className="fab__actions">
        ...
        <a href={`tel:${phone}`} className="fab__action fab__action--call" aria-label="Call" title="Call">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        ...
        <a href={`mailto:${email}`} className="fab__action fab__action--mail" aria-label="Email" title="Email">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
